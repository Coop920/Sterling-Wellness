...
<div class="two-col-layout layout-component">
	<div class="column left section-title">
		...
		?>
			...
			<div class="rows-wrap">
				<div class="two-col-list-wrap">
					...
					?>
				</div><!-- end two-col-list-wrap -->	
			</div><!-- end rows-wrap -->
			<!-- end 2col list repeater -->

		<?php
			//Check ACF Extended Layout Options
			elseif( $layout_options == '2_col_image' ) :
			// ACF Variables
			$image	= get_sub_field('2_col_image');	
		?>
			<div class="rows-wrap">		
				<div class="two-col-image-full">
					<img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>">
				</div><!-- end two-col-image-full -->
			</div><!-- end rows wrap -->
